...
if ($('.utm_source').is("[value*='google']")) {
...
} else if ($('.utm_source').is("[value*='facebook']")) {
    //---- FACEBOOK
    ...
    //-------------
} else if ($('.utm_source').is("[value*='ApartmentsCom']")) {
    //---- APARTMENTS.COM
    ...
    //-------------
} else if ($('.utm_source').is("[value*='newsletter']")) {
    //---- EBLAST
    ...
    //-------------
} else if ($('.utm_source').is("[value*='mailer']")) {
    //---- DIRECT MAILER
    ...
    //-------------
} else if ($('.utm_source').is("[value*='printed']")) {
    //---- PRINTED MATERIALS
    ...
    //-------------
} else if ($('.utm_source').is("[value*='tiktok']")) {
    //---- TIKTOK
    ...
    //-------------
} else if ($('.utm_source').is("[value*='twitter']")) {
    //---- TWITTER
